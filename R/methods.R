...
#' Show method for S4 object of class \linkS4class{DataInfo}.
#'
...
#' Show method for S4 object of class \linkS4class{FuturesHistorical}.
#'
...
#' Show method for S4 object of class \linkS4class{EquityHistorical}.
#'
...
#' Show method for S4 object of class \linkS4class{FundHistorical}.
#'
...
#' Show method for S4 object of class \linkS4class{FuturesTS}..
#'
...
#' Show method for S4 object of class \linkS4class{FuturesCFTC}..
#'
...
#' 'info' slot accessor method for S4 objects of class \linkS4class{DataInfo}.
#'
...
#' 'active_contract_tickers' slot accessor method for S4 objects of class \linkS4class{FuturesHistorical}.
#'
...
#' 'term_structure_tickers' slot accessor method for S4 objects of class \linkS4class{FuturesTS}.
#'
...
#' 'cftc_tickers' slot accessor method for S4 objects of class \linkS4class{FuturesCFTC}.
#'
...
#' 'fields' slot accessor method for S4 objects of class \linkS4class{DataInfo} & childs.
#'
...
#' 'fields' slot accessor method for S4 objects of class \linkS4class{DataHistorical} & childs.
#'
#' @rdname get_fields-methods
...
#' 'data' slot accessor method for S4 objects of class \linkS4class{DataHistorical} & childs.
#'
...
#' 'call' slot accessor method for S4 objects of class \linkS4class{DataInfo}.
#'
...
#' 'call' slot accessor method for S4 objects of class \linkS4class{DataHistorical}.
#'
#' @rdname get_call-methods
...
#' 'periods' method for S4 objects of class \linkS4class{DataHistorical}.
#'
#' @return A data.table showing, for each equity ticker the start and end
#'   dates of the historical data time series contained in the object.
#'
...
#' 'periods' method for S4 objects of class \linkS4class{FuturesMarket}.
#'
#' @return A data.table showing, for each futures active contract (and term structure contract for
#'   \linkS4class{FuturesTS} objects) and each field the start and end dates of the historical
#'   data time series contained in the object.
#'
#' @rdname get_periods-methods
...
#'
#' @return A data.table showing, for each active contract and position tickers
#'   the start and end dates of the historical data time series contained in the object.
#'
#' @rdname get_periods-methods
