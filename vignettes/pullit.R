...
#  library(storethat)
#  
#  tickers <- c("ADM US Equity", "KHC US Equity", "XPO US Equity"); storethat <- "../data-raw/storethat.sqlite"
...
#  tickers <- c("SPY US Equity", "GLD US Equity", "EEM US Equity")
#  
#  fund_market <- pull_fund_market(source = "storethat", tickers, start, end, verbose = F, file = storethat)
...
#                                    roll_adjustment = "N", verbose = F, file = storethat)
